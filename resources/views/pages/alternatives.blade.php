    ...
    <div class="card-body">
        ...
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <form method="GET" action="{{ route('alternatives.index') }}" class="d-flex w-50">
                <input type="text" name="search" class="form-control w-100" placeholder="Cari kode atau nama alternatif..."
                    value="{{ $search ?? '' }}">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($alt->image)
                                            <img src="{{ asset('storage/'.$alt->image) }}" alt="{{ $alt->name }}"
                                                width="80" class="mt-2">
                                            @endif
                                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <input type="number" step="any" class="form-control"
                                        name="criteria[{{ $criteria->uuid }}]" required value="0">
                                </div>
                                <div class="col-md-2 text-left">
                                    <p>{{$criteria->unit->name}}</p>
                                </div>
                            </div>
                        </div>
                        @endforeach
